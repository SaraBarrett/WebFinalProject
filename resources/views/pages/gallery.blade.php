...
@section('content')
    ...
    <div class="table-responsive">
        <table class="table table-borderless align-middle text-center">
            <tbody>
                <tr>
                    <td><img src="{{ asset('images/businesspeople-office-meeting.jpg') }}" class="gallery-img" alt="View 1">
                    </td>
                    ...
                    <td><img src="{{ asset('images/laboratory-supplies-medical-work.jpg') }}" class="gallery-img"
                            alt="View 3"></td>
                </tr>
                <tr>
